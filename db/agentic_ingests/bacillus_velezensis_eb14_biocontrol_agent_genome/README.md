# Agentic ingest snapshot — Bacillus velezensis EB14 Biocontrol Agent Genome
...
|---|---:|---|
| `PRJNA681597.nmdc.json` | 1 | NMDC `Database` JSON |
...
uv run nmdc-ingest-ncbi PRJNA681597 --out PRJNA681597.json
```
...
|---|---|---:|---:|---:|---:|---:|
| `PRJNA681597` | `env_broad_scale` | – | – | – | 1 | – |
| `PRJNA681597` | `env_local_scale` | – | – | – | 1 | – |
| `PRJNA681597` | `env_medium` | – | 1 | – | – | – |
