# Agentic ingest snapshot — Climate-driven Divergence in Plant-Microbiome Interactions
...
|---|---:|---|
| `PRJNA726831.nmdc.json` | 539 | NMDC `Database` JSON |
...
uv run nmdc-ingest-ncbi PRJNA726831 --out PRJNA726831.json
```
...
|---|---|---:|---:|---:|---:|---:|
| `PRJNA726831` | `env_broad_scale` | – | – | – | – | 539 |
| `PRJNA726831` | `env_local_scale` | – | – | – | – | 539 |
| `PRJNA726831` | `env_medium` | – | 539 | – | – | – |
