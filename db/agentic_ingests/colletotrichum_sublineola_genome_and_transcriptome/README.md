# Agentic ingest snapshot — Colletotrichum sublineola Genome and Transcriptome
...
|---|---:|---|
| `PRJNA659716.nmdc.json` | 1 | NMDC `Database` JSON |
...
uv run nmdc-ingest-ncbi PRJNA659716 --out PRJNA659716.json
```
...
|---|---|---:|---:|---:|---:|---:|
| `PRJNA659716` | `env_broad_scale` | – | – | – | – | 1 |
| `PRJNA659716` | `env_local_scale` | – | – | – | – | 1 |
| `PRJNA659716` | `env_medium` | – | – | – | – | 1 |
