# Agentic ingest snapshot — Corynebacterial Cell Envelope and Phage Resistance
...
|---|---:|---|
| `PRJNA834153.nmdc.json` | 18 | NMDC `Database` JSON |
...
uv run nmdc-ingest-ncbi PRJNA834153 --out PRJNA834153.json
```
...
|---|---|---:|---:|---:|---:|---:|
| `PRJNA834153` | `env_broad_scale` | – | – | – | – | 18 |
| `PRJNA834153` | `env_local_scale` | – | – | – | – | 18 |
| `PRJNA834153` | `env_medium` | – | – | – | – | 18 |
