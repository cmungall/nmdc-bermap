# Agentic ingest snapshot — Cultivating Bacterial Microbiota of Populus Roots
...
|---|---:|---|
| `PRJNA666202.nmdc.json` | 198 | NMDC `Database` JSON |
...
uv run nmdc-ingest-ncbi PRJNA666202 --out PRJNA666202.json
```
...
|---|---|---:|---:|---:|---:|---:|
| `PRJNA666202` | `env_broad_scale` | 198 | – | – | – | – |
| `PRJNA666202` | `env_local_scale` | 132 | – | – | 66 | – |
| `PRJNA666202` | `env_medium` | 198 | – | – | – | – |
