# Agentic ingest snapshot — East Fork Poplar Creek Sediment Metagenomes
...
|---|---:|---|
| `PRJNA670906.nmdc.json` | 1 | NMDC `Database` JSON |
...
uv run nmdc-ingest-ncbi PRJNA670906 --out PRJNA670906.json
```
...
|---|---|---:|---:|---:|---:|---:|
| `PRJNA670906` | `env_broad_scale` | 1 | – | – | – | – |
| `PRJNA670906` | `env_local_scale` | 1 | – | – | – | – |
| `PRJNA670906` | `env_medium` | 1 | – | – | – | – |
