# Agentic ingest snapshot — ENIGMA Groundwater Archaeal Diversity
...
|---|---:|---|
| `PRJNA268032.nmdc.json` | 16 | NMDC `Database` JSON |
...
uv run nmdc-ingest-ncbi PRJNA268032 --out PRJNA268032.json
```
...
|---|---|---:|---:|---:|---:|---:|
| `PRJNA268032` | `env_broad_scale` | 16 | – | – | – | – |
| `PRJNA268032` | `env_local_scale` | 16 | – | – | – | – |
| `PRJNA268032` | `env_medium` | 16 | – | – | – | – |
