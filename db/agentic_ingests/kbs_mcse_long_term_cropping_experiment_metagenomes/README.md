# Agentic ingest snapshot — KBS MCSE Long-term Cropping Experiment Metagenomes
...
|---|---:|---|
| `PRJNA1156252.nmdc.json` | 106 | NMDC `Database` JSON |
...
uv run nmdc-ingest-ncbi PRJNA1156252 --out PRJNA1156252.json
```
...
|---|---|---:|---:|---:|---:|---:|
| `PRJNA1156252` | `env_broad_scale` | – | – | – | – | 106 |
| `PRJNA1156252` | `env_local_scale` | – | – | 106 | – | – |
| `PRJNA1156252` | `env_medium` | – | – | 106 | – | – |
