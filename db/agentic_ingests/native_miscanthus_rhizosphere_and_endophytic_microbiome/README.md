# Agentic ingest snapshot — Native Miscanthus Rhizosphere and Endophytic Microbiome
...
|---|---:|---|
| `PRJNA561781.nmdc.json` | 466 | NMDC `Database` JSON |
...
uv run nmdc-ingest-ncbi PRJNA561781 --out PRJNA561781.json
```
...
|---|---|---:|---:|---:|---:|---:|
| `PRJNA561781` | `env_broad_scale` | 466 | – | – | – | – |
| `PRJNA561781` | `env_local_scale` | – | 466 | – | – | – |
| `PRJNA561781` | `env_medium` | 233 | 233 | – | – | – |
