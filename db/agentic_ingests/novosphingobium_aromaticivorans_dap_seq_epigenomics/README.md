# Agentic ingest snapshot — Novosphingobium aromaticivorans DAP-seq Epigenomics
...
|---|---:|---|
| `PRJNA1228656.nmdc.json` | 1 | NMDC `Database` JSON |
...
uv run nmdc-ingest-ncbi PRJNA1228656 --out PRJNA1228656.json
```
...
|---|---|---:|---:|---:|---:|---:|
| `PRJNA1228656` | `env_broad_scale` | – | – | – | – | 1 |
| `PRJNA1228656` | `env_local_scale` | – | – | – | – | 1 |
| `PRJNA1228656` | `env_medium` | – | – | – | – | 1 |
