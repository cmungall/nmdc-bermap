# Agentic ingest snapshot — Oak Ridge Groundwater 100-Well Survey Metagenomes
...
|---|---:|---|
| `PRJNA1001011.nmdc.json` | 140 | NMDC `Database` JSON |
...
uv run nmdc-ingest-ncbi PRJNA1001011 --out PRJNA1001011.json
```
...
|---|---|---:|---:|---:|---:|---:|
| `PRJNA1001011` | `env_broad_scale` | 136 | – | – | 4 | – |
| `PRJNA1001011` | `env_local_scale` | 136 | – | – | 4 | – |
| `PRJNA1001011` | `env_medium` | 136 | – | – | 4 | – |
