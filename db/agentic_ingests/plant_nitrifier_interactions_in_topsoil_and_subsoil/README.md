# Agentic ingest snapshot — Plant-Nitrifier Interactions in Topsoil and Subsoil
...
|---|---:|---|
| `PRJNA1080623.nmdc.json` | 103 | NMDC `Database` JSON |
...
uv run nmdc-ingest-ncbi PRJNA1080623 --out PRJNA1080623.json
```
...
|---|---|---:|---:|---:|---:|---:|
| `PRJNA1080623` | `env_broad_scale` | 103 | – | – | – | – |
| `PRJNA1080623` | `env_local_scale` | – | – | 103 | – | – |
| `PRJNA1080623` | `env_medium` | – | – | 103 | – | – |
