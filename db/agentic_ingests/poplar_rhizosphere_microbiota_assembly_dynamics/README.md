# Agentic ingest snapshot — Poplar Rhizosphere Microbiota Assembly Dynamics
...
|---|---:|---|
| `PRJNA1017804.nmdc.json` | 509 | NMDC `Database` JSON |
...
uv run nmdc-ingest-ncbi PRJNA1017804 --out PRJNA1017804.json
```
...
|---|---|---:|---:|---:|---:|---:|
| `PRJNA1017804` | `env_broad_scale` | 509 | – | – | – | – |
| `PRJNA1017804` | `env_local_scale` | 255 | – | – | – | 254 |
| `PRJNA1017804` | `env_medium` | 509 | – | – | – | – |
