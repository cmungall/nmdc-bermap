# Agentic ingest snapshot — Populus Variovorax SynCom28 Compartment Partitioning
...
|---|---:|---|
| `PRJNA1322484.nmdc.json` | 15 | NMDC `Database` JSON |
...
uv run nmdc-ingest-ncbi PRJNA1322484 --out PRJNA1322484.json
```
...
|---|---|---:|---:|---:|---:|---:|
| `PRJNA1322484` | `env_broad_scale` | – | – | – | – | 15 |
| `PRJNA1322484` | `env_local_scale` | – | 8 | – | – | 7 |
| `PRJNA1322484` | `env_medium` | 15 | – | – | – | – |
