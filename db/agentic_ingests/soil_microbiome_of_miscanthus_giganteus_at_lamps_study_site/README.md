# Agentic ingest snapshot — Soil Microbiome of Miscanthus × giganteus at LAMPS Study Sit
...
|---|---:|---|
| `PRJNA745191.nmdc.json` | 271 | NMDC `Database` JSON |
...
uv run nmdc-ingest-ncbi PRJNA745191 --out PRJNA745191.json
```
