# Agentic ingest snapshot — Sorghum Rhizosphere Nitrification Study
...
|---|---:|---|
| `PRJNA741261.nmdc.json` | 288 | NMDC `Database` JSON |
...
uv run nmdc-ingest-ncbi PRJNA741261 --out PRJNA741261.json
```
...
|---|---|---:|---:|---:|---:|---:|
| `PRJNA741261` | `env_broad_scale` | – | 288 | – | – | – |
| `PRJNA741261` | `env_local_scale` | – | 288 | – | – | – |
| `PRJNA741261` | `env_medium` | – | 288 | – | – | – |
