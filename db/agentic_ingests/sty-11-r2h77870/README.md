# Agentic ingest snapshot — Bio-Scales - Integrated Metagenomic, Metabolomic and Transcr
...
**NMDC study:** `nmdc:sty-11-r2h77870`
...
|---|---:|---|
| `PRJNA1034652.nmdc.json` | 0 | NMDC `Database` JSON |
...
uv run nmdc-ingest-ncbi PRJNA1034652 --out PRJNA1034652.json
```
