# Agentic ingest snapshot — Sugarcane and Oilcane Microbiome Differences
...
|---|---:|---|
| `PRJNA892137.nmdc.json` | 200 | NMDC `Database` JSON |
...
uv run nmdc-ingest-ncbi PRJNA892137 --out PRJNA892137.json
```
...
|---|---|---:|---:|---:|---:|---:|
| `PRJNA892137` | `env_broad_scale` | – | – | – | – | 200 |
| `PRJNA892137` | `env_local_scale` | 80 | – | – | – | 120 |
| `PRJNA892137` | `env_medium` | 200 | – | – | – | – |
