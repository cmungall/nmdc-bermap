# Agentic ingest snapshot — Terpene Effects on Sorghum Microbiome
...
|---|---:|---|
| `PRJNA933671.nmdc.json` | 228 | NMDC `Database` JSON |
...
uv run nmdc-ingest-ncbi PRJNA933671 --out PRJNA933671.json
```
...
|---|---|---:|---:|---:|---:|---:|
| `PRJNA933671` | `env_broad_scale` | 228 | – | – | – | – |
| `PRJNA933671` | `env_local_scale` | 168 | – | – | – | 60 |
| `PRJNA933671` | `env_medium` | 228 | – | – | – | – |
